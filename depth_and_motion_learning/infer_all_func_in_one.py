...
def run_local_inference(input_fn,
  ...
  """
    ...
    plt.savefig("/data2/zinan_xiong/depth/data/results/hist_01.png")

    depth_img = np.reshape(predict_output_np, (128, 416))
    max_val = np.max(depth_img)
    depth_img = depth_img * (255 / max_val)
    cv2.imwrite("/data2/zinan_xiong/depth/data/results/output_01.png", depth_img)
    ...
    print("\n\nPRE EXPORT MODEL")
    estimator.export_savedmodel("/data2/zinan_xiong/depth/output",
...
def main(argv):
    ...
    image_file = "/data2/zinan_xiong/depth/data/test_set/test_01.jpg"
    filename = "/data2/zinan_xiong/depth/data/test_set/test_01"
